...
import numpy as np
import os
from AggregateValueSyst import FormalisationObjects,FormalisationMatrix
...
if __name__ == '__main__':
    ...
    B_,b_,C_,c_ = FormalisationMatrix(P_list,J_list,w)
    ...
    if args.l:
        ...
        while True:
            ...
            slope = du / incr
            if du/u_1 < args.e:
                print(' (ΔU/U1 = {:.4f} < {})'.format(du/u_1, args.e))
                break
            else:
                print(' (ΔU/U1 = {:.4f} > {})'.format(du/u_1, args.e))
                ua = ub
        ...
        dist_pl = np.linalg.norm(cons_l - cons_1, 1)
